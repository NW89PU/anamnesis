...
UI демо-пациента (свежая установка, до подключения AI-координатора):

<p align="center">
  <img src="docs/assets/visit-form.jpg" alt="Форма создания приёма (десктоп + мобайл)" width="800" />
</p>

Больше скриншотов будет добавлено по мере развития публичной версии. Пока лучший способ увидеть интерфейс — запустить `npm run dev` локально.
